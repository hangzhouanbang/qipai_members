...
public class MemberController {
	...
	public CommonVO rechargeVip(String memberId, Long vipEndTime) {
		CommonVO vo = new CommonVO();
		MemberDbo member = memberAuthQueryService.agentRechargeVip(memberId, vipEndTime);
		membersMsgService.rechargeVip(member);
		vo.setSuccess(true);
		vo.setMsg("success");
		return vo;
	...
	@RequestMapping("/update_viptime_id")
	public CommonVO update_viptime_id(@RequestBody String id, Long vipEndTime) {
		CommonVO vo = new CommonVO();
		MemberDbo member = memberAuthQueryService.rechargeVip(id, vipEndTime);
		member.setVip(true);
		membersMsgService.rechargeVip(member);
