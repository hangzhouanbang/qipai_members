...
public class Member {
	...
	public String toString() {
		return "Member [id=" + id + ", nickname=" + nickname + ", gender=" + gender + ", vip=" + vip + ", vipLevel="
				+ vipLevel + ", vipScore=" + vipScore + ", headimgurl=" + headimgurl + ", phone=" + phone + ", score="
				+ score + ", gold=" + gold + ", createTime=" + createTime + ", vipEndTime=" + vipEndTime + "]";
	}
